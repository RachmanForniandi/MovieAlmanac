...
object DataTvShow {
    ...
    fun generateDummyTvShow():List<TvShowDummy>{
        val tvShowsItem: ArrayList<TvShowDummy> = ArrayList()
        tvShowsItem.add(TvShowDummy(1412,
                "Arrow",
                140.526,
                "2012-10-10",
                ...
                6.5))
        tvShowsItem.add(TvShowDummy(79501,
                "Doom Patrol",
                68.289,
                "2019-02-15",
                ...
                7.6))
        tvShowsItem.add(TvShowDummy(12971,
                "Dragon Ball Z",
                169.971,
                "1989-04-26",
        ...
        tvShowsItem.add(TvShowDummy(46261,
                "Fairy Tail",
                26.987,
                "2009-10-12",
                ...
                7.6))
        tvShowsItem.add(TvShowDummy(1434,
                "Family guy",
                145.797,
                "1999-01-31",
                ...
                6.9))
        tvShowsItem.add(TvShowDummy(60735,
                "The Flash",
                244.514,
                "2014-10-07",
                ...
                7.6))
        tvShowsItem.add(TvShowDummy(1399,
                "Game Of Thrones",
                324.094,
                "2011-04-17",
                ...
                8.3))
        tvShowsItem.add(TvShowDummy(60708,
                "Gotham",
                124.673,
                "2014-09-22",
                ...
                7.4))
        tvShowsItem.add(TvShowDummy(1416,
                "Grey's Anatomy",
                759.096,
                "2005-03-27",
                ...
                8.1))
        tvShowsItem.add(TvShowDummy(54155,
                "Hanna",
                30.266,
                "2019-03-28",
    ...
    fun tvShowDetail(id: Int): TvShowDummy {
        return generateDummyTvShow()[id - 1]
    }
}